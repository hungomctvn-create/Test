...
- Preview ưu tiên cấu hình still (sRGB + RGB888) để khớp màu/độ nét với ảnh lưu.
...
class CameraGUI:
    def __init__(self, root: tk.Tk, save_dir: str = "/home/hungomctvn"):
        ...
        # Preview ưu tiên cấu hình still; fallback preview/lores khi cần
